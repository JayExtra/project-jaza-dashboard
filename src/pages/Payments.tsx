    ...
    <div className="w-full h-full flex flex-col p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 className="text-5xl font-display font-semibold text-primary">Payments</h1>
        </div>
      </div>
      <div className="flex-1 flex items-center justify-center bg-surface-lowest rounded-[2rem] shadow-ambient">
        <p className="text-foreground/40 text-sm">Payment transactions and billing history will appear here.</p>
      </div>
    </div>
  );
};
